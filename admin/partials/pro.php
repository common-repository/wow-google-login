<div class="wow-admin-col">	
	<div class="wow-admin-col-12">
		...
		<a href="https://wow-estore.com/item/wow-google-login-pro/" target="_blank" class="wow-btn">GET PRO VERSION <i class="fa fa-download"></i></a> <a href="http://wow-demo.com/wow-google-login-pro/" target="_blank" class="wow-btn">DEMO PRO VERSION <i class="fa fa-eye"></i></a>
		</p>
	</div>	
</div>
...
<div class="wow-admin-col">	
	...
	<div class="wow-admin-col-6 right">
		<a href="https://wow-estore.com/item/wow-google-login-pro/" target="_blank" class="wow-btn">GET PRO VERSION</a>
	</div>
</div>
...
<p style="font-size:18px;">We will be very grateful if you <a href="https://wow-estore.com/item/wow-google-login-pro/" target="_blank"><b/>leave a review about the plugin</b></a>.</p>
